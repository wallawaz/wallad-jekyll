...
### View Results
{: .archiveIntroUnderline}

[Separate Debates](#charts)
{: .archiveIntro}

[Debate Summary](#chart_summary)
{: .archiveIntro}

First, in order to use the **Tone Analyzer**, I needed the transcribed speech text of each debate.
So, I built a parser to extract the speech text from a given article url.
